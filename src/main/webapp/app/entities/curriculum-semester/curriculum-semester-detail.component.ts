...
@Component({
    selector: 'jhi-curriculum-semester-detail',
    templateUrl: './curriculum-semester-detail.component.html'
})
export class CurriculumSemesterDetailComponent implements OnInit, OnDestroy {
