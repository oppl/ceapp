...
public class CollisionLevelThreeResourceIntTest {
    ...
    public void createCollisionLevelThree() throws Exception {
        ...
        assertThat(testCollisionLevelThree.getCountCollisionLvas()).isEqualTo(DEFAULT_COUNT_COLLISION_LVAS);
    ...
    public void updateCollisionLevelThree() throws Exception {
        ...
        assertThat(testCollisionLevelThree.getCountCollisionLvas()).isEqualTo(UPDATED_COUNT_COLLISION_LVAS);
